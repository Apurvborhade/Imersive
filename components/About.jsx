    ...
    return (
        <div className='about-section'>
            <div className='flex flex-col items-center py-20'>
                <h3 className='text-center text-3xl w-mid'>
                ...
                <div className='showcase-header pl-20'>
                    ...
                    <div className='slider-container relative mt-10'>
                        <div className='inner-slider'>
                            <img src='https://images.unsplash.com/photo-1677311573471-fcd492a8b2d9?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHx0b3BpYy1mZWVkfDExM3xDRHd1d1hKQWJFd3x8ZW58MHx8fHw%3D&auto=format&fit=crop&w=500&q=60' />
                            <img src='https://images.unsplash.com/photo-1677311573471-fcd492a8b2d9?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHx0b3BpYy1mZWVkfDExM3xDRHd1d1hKQWJFd3x8ZW58MHx8fHw%3D&auto=format&fit=crop&w=500&q=60' />
                            <img src='https://images.unsplash.com/photo-1677311573471-fcd492a8b2d9?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHx0b3BpYy1mZWVkfDExM3xDRHd1d1hKQWJFd3x8ZW58MHx8fHw%3D&auto=format&fit=crop&w=500&q=60' />
                            <img src='https://images.unsplash.com/photo-1677311573471-fcd492a8b2d9?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHx0b3BpYy1mZWVkfDExM3xDRHd1d1hKQWJFd3x8ZW58MHx8fHw%3D&auto=format&fit=crop&w=500&q=60' />
                            <img src='https://images.unsplash.com/photo-1677311573471-fcd492a8b2d9?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHx0b3BpYy1mZWVkfDExM3xDRHd1d1hKQWJFd3x8ZW58MHx8fHw%3D&auto=format&fit=crop&w=500&q=60' />
            ...
            <div className='product-features px-20 mt-32'>
                <div className='product-features-header'>
                    <h2 className='text-5xl  poppins'>Discover the compelling reasons why retailers should choose Us</h2>
                </div>
                <div className='product-features-body grid grid-cols-9 gap-2 mt-10'>
